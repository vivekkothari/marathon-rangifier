...
public class MarathonServiceClient {
    ...
    private static final LabelSelectorQuery query = LabelSelectorQuery.builder()
            .addQueryElement(QueryElement.builder()
                                     .lhs(ZK_SERVICE_NAME)
                                     .operator(EXISTS)
                                     .build())
            .build();
    ...
    public Set<ServiceInstance> getInstances() {
        ...
        List<App> apps = marathon.getApps(query.getQuery())
                .getApps();
        ...
        apps.forEach(app -> {
            ...
            tasks = tasks == null ? marathon.getAppTasks(app.getId())
                    .getTasks() : tasks;
            tasks.forEach(task -> {
